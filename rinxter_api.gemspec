...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A Ruby API Client wrapping Rinxter Data API calls'
  spec.description   = 'A nifty client to interact with the Rinxter data source for Roller Derby statistics'
